...
#### 3. System Identity and System Clock
* System Indentity
```
/system identity
...
#### 2. System Identity and System Clock
* System Indentity
```
/system identity
...
### A. MikroTik CHR on VPS and MikroTik RB2011
#### 1. Drop Brute Force SSH
* Firewall Filter
```
/ip firewall filter
...
#### 2. Privilege Login Access-List
<p align="left">
<img src="img/useracclist.png">
</p>

#### 3. Custom Port IP Services
...
#### 4. Disable Bandwidth Server
```
/tool bandwidth-server
set authenticate=no enabled=no
```

#### 5. Disable Mac-Server
```
/tool mac-server
...
#### 7. Disable Neighbor Discovery
```
/ip neighbor discovery-settings
set discover-interface-list=none protocol=""
```

#### 8. Disable SMB Default
```
/ip smb
set allow-guests=no
```
...
#### 3. Firewall Forwarding to Cloudflare
```
/ip firewall nat
